...
class _UserManagementPageState extends State<UserManagementPage> {
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      ...
      final tableHead = ['code', 'ID', 'email', 'name', 'lang', 'role', 'groups', 'regdate', 'flag'];
        ...
        children: [
          ...
          Expanded(
            child: _isLoading
                ...
                : Card(
                    child: _buildUserTable(localizations),
                  ),
          ),
        ],
      ),
  ...
  Widget _buildUserTable(AppLocalizations localizations) {
    return SingleChildScrollView(
      ...
      child: SingleChildScrollView(
        child: DataTable(
          columns: [
            DataColumn(label: Text(localizations.code, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
            DataColumn(label: Text("ID", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
            DataColumn(label: Text(localizations.name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
            DataColumn(label: Text(localizations.email, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
            DataColumn(label: Text(localizations.language, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
            DataColumn(label: Text(localizations.role, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
            DataColumn(label: Text(localizations.registrationDate, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
            DataColumn(label: Text(localizations.status, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
            DataColumn(label: Text(localizations.actions, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14))),
          ],
          rows: _filteredUsers.map((user) {
            return DataRow(
              cells: [
                DataCell(Text(user['id'], style: const TextStyle(fontSize: 14, color: Colors.black87))),
                DataCell(Text(user['username'], style: const TextStyle(fontSize: 14, color: Colors.black87))),
                DataCell(Text(user['name'], style: const TextStyle(fontSize: 14, color: Colors.black87))),
                DataCell(Text(user['email'], style: const TextStyle(fontSize: 14, color: Colors.black87))),
                DataCell(Text(
                  _getLanguageName(user['lang'], localizations),
                  style: const TextStyle(fontSize: 14, color: Colors.black87)
                )),
                DataCell(Text(_getRoleName(user['role'], localizations), style: const TextStyle(fontSize: 14, color: Colors.black87))),
                DataCell(Text(user['lastLogin'], style: const TextStyle(fontSize: 14, color: Colors.black87))),
                DataCell(
                  Container(
                    ...
                    child: Text(
                      user['status'],
                      style: TextStyle(
                        color: user['status'] == 'active' ? Colors.green[800] : Colors.red[800],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        tooltip: user['status'] == 'active' ? localizations.deactivate : localizations.activate,
                      ),
                    ],
                  ),
                ),
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                value: selectedRole,
                items: [
                  DropdownMenuItem(value: 'admin', child: Text(localizations.admin)),
                  DropdownMenuItem(value: 'operator', child: Text(localizations.operator)),
                  DropdownMenuItem(value: 'user', child: Text(localizations.user)),
                  DropdownMenuItem(value: 'installer', child: Text(localizations.installer)),
                ],
                onChanged: (value) {
                  selectedRole = value!;
                },
              ...
              DropdownButtonFormField<String>(
                ...
                value: selectedLang,
                items: [
                  DropdownMenuItem(value: 'kor', child: Text(localizations.korean)),
                  DropdownMenuItem(value: 'eng', child: Text(localizations.english)),
                  DropdownMenuItem(value: 'chn', child: Text(localizations.chinese)),
                ],
                onChanged: (value) {
                  selectedLang = value!;
                },
    ...
    if (success) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('${user['name']} 사용자가 ${newStatus == '활성' ? '활성화' : '비활성화'}되었습니다.'),
